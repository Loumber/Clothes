...
class EditClothesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ClothesInfo item = ModalRoute.of(context)!.settings.arguments as ClothesInfo;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title:  Text('Clothes', style: TextStyle(fontSize: 26, color: CustomColors.dark_brown_tint),),
      ),
