                ...
                children: [
                  Container(
                    child: Column(
                      ...
                      children: [
                        Container(
                            child: Text('Ростов-на-Дону', style: TextStyle(fontFamily: 'Montserrat', color:CustomColors.light_coffee_clr ),)
                        ),
                        SizedBox(height: 10,),
                        Container(
                          child: Text('18°C', style: TextStyle(fontFamily: 'Montserrat',color:CustomColors.light_coffee_clr, fontSize: 34),),
                        )
                      ],
                    ),
                  ),
